...
type PathTree[U any, A any] struct {
	root                   *PathNode[U, A]
	Relative               bool
	InitUserData           func(value *PathNode[U, A])
	UpdateUserData         func(value *PathNode[U, A], arg A)
	UpdateImplicitUserData func(value *PathNode[U, A], arg A)
}

type PathNode[U any, A any] struct {
	tree   *PathTree[U, A]
	parent *PathNode[U, A]
	flags  int
}
