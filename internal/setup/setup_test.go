...
var setupTests = []setupTest{{
	...
	release: &setup.Release{
		...
		Archives: map[string]*setup.Archive{"ubuntu": {"ubuntu", "22.04", []string{"jammy", "jammy-security"}, []string{"main", "other"}, setup.ProNone}},
	...
	release: &setup.Release{
		...
		Archives: map[string]*setup.Archive{"ubuntu": {"ubuntu", "22.04", []string{"jammy"}, []string{"main", "universe"}, setup.ProNone}},
		Packages: map[string]*setup.Package{
			"mypkg": {
				Archive: "ubuntu",
				Name:    "mypkg",
	...
	release: &setup.Release{
		...
		Archives: map[string]*setup.Archive{
			"foo": {"foo", "22.04", []string{"jammy"}, []string{"main", "universe"}, setup.ProNone},
			"bar": {"bar", "22.04", []string{"jammy-updates"}, []string{"universe"}, setup.ProNone},
		},
		Packages: map[string]*setup.Package{
			"mypkg": {
				Archive: "foo",
	...
	release: &setup.Release{
		...
		Archives: map[string]*setup.Archive{
			"ubuntu":      {"ubuntu", "22.04", []string{"jammy", "jammy-updates", "jammy-security"}, []string{"main", "universe"}, setup.ProNone},
			"ubuntu-fips": {"ubuntu-fips", "22.04", []string{"jammy"}, []string{"main"}, setup.ProFIPS},
		},
		Packages: map[string]*setup.Package{
			"mypkg": {
				Archive: "ubuntu",
